...
A,B,k = GreConD(np.loadtxt("data/zoo/spectral-ordering-pearson-bfp/spectral-ordering-pearson-bfp.csv", delimiter=",", dtype=int))
np.savetxt("data/zoo/spectral-ordering-pearson-bfp/spectral-ordering-pearson-bfp-grecond-A.csv", A, delimiter=",")
np.savetxt("data/zoo/spectral-ordering-pearson-bfp/spectral-ordering-pearson-bfp-grecond-B.csv", B, delimiter=",")
np.savetxt("data/zoo/spectral-ordering-pearson-bfp/spectral-ordering-pearson-bfp-grecond-k.txt", [k], delimiter=",")
# print(k)
